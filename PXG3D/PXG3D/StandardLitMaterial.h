...
namespace PXG
{
	...
	public:
		...
		StandardLitMaterial(Vector3 ambient = Vector3(1.0,1.0,1.0), Vector3 diffuse = Vector3(1.0, 1.0, 1.0), Vector3 speculars = Vector3(1.0, 1.0, 1.0), float shininess = 32.0f);
